...
MarkerForm -> SolidManagement: reload the existing markers
...
MarkerInfo -> SolidManagement: Delete the location
MarkerInfo -> SolidManagement: reload the existing markers
